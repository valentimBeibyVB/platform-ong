...
<head>
    ...
    <title>Eterno Centro de Doações</title>
            ...
            <div class="container">
                <div class="row" role="listbox">
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="doacao">
                            <img src="assets/img/team/2.jpg" alt=""><br>
                            <br>
                            <span>Voluntarios da amar oferecem ajuda medica</span>
                            <p>
                                Uma comunidades recebe ajuda de voluntario medico da associação Remar
                            </p>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="doacao">
                            ...
                            <h4>Doador</h4>
                            <span>Desponivel para doar sem beneficiario</span>
                            <p>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch">
                        <div class="icon-box">
                            ...
                            <a href="doar.php" class="getstarted" data-bs-toggle="modal" data-bs-target="#Doar">Doar</a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4">
                        <div class="icon-box">
                            ...
                            <a href="" class="getstarted">Ajudar</a>
                        </div>
                    </div>
